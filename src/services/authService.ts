...
const authService = {
    ...
    async logout(refreshToken: string): Promise<REPOSITORY_RESPONSES.SUCCESSFULLY | REPOSITORY_RESPONSES.UNSUCCESSFULLY> {
        return await invalidRefreshTokensRepository.addRefreshTokenToInvalid(refreshToken)
    },
